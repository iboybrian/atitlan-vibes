    ...
    return (
        <div className="px-4 py-6 max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-black text-gray-900 dark:text-white">{t('about.title')}</h1>
            ...
            <Accordion label={t('about.section1')} defaultOpen={true}>
                <div className="pt-4 space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{t('about.intro')}</p>

                    <div className="pt-2">
                        <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3">{t('about.whyLove')}</h3>

                        <div className="space-y-4">
                            {['vibeSearch', 'zeroNoise', 'creator', 'inside'].map(key => (
                                <div key={key} className="bg-gray-50 dark:bg-slate-700 p-4 rounded-xl">
                                    <h4 className="font-bold text-turquoise mb-1">{t(`about.${key}`)}</h4>
                                    <p className="text-sm text-gray-600 dark:text-gray-300">{t(`about.${key}Body`)}</p>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <Accordion label={t('about.contact')}>
                <div className="pt-4">
                    <p className="text-gray-600 dark:text-gray-300 mb-4">{t('about.contactBody')}</p>
                    <a
